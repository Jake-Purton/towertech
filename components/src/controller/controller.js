    ...
    constructor(scene_info){
        ...
        this.tower_data = {
            ...
            "LaserTower":{title:"Laser", description:"its not a cannon", level_stats:[
                    {level:1, cost:25, damage:1, fire_rate:10, range:180},
                    {level:2, cost:40, damage:1, fire_rate:10, range:180},
                    {level:3, cost:60, damage:1, fire_rate:10, range:180},
                ]},
        ...
        this.parts_data = {
            ...
            //         {health:-2, speed:12},
            //         {health:-4, speed:16, upgrade_cost:8, upgrade_number:3},
            //         {health:-6, speed:20, upgrade_cost:12, upgrade_number:3},
            //     ]},
            ...
            //         {health:5, speed:10},
            //         {health:6, speed:12, upgrade_cost:8, upgrade_number:3},
            //         {health:8, speed:14, upgrade_cost:12, upgrade_number:3},
            //     ]},
